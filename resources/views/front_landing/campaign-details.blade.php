                    ...
                    <div class="col-xl-8 ">
                        <div class="cause-image mb-20 rounded-20">
                            {{-- <img src="{{asset($campaign->image ? : 'front_landing/images/card-img.png')}}"
                                 ...
                                 <img src="{{asset('front_landing/images/hero-image.png')}}"
                                 alt="causes-image" class="w-100 h-100 object-fit-cover">
                                            ...
                                            @if($relatedCampaign->id != $campaign->id && $relatedCampaign->status == \App\Models\Campaign::STATUS_ACTIVE && !campaignEnd($relatedCampaign->id))
                                                <div class="col-md-6 trending-card mb-md-0 mb-40 pb-3">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <h4 class="card-title text-danger fw-5 fs-14">
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between" style="display: none">
                                                                <div class="col-7">
                                                        {{-- <span 
                                                                class="count-num count-num1 me-1 text-dark fs-14 fw-5">{{getRaisedAmountPercentage($relatedCampaign->campaignDonations->sum('donated_amount'),$relatedCampaign->goal)}}%</span>
                                                                    <span class="text-danger fs-14">{{__('messages.front_landing.raised')}}</span> --}}
                                                                </div>
                                                                <div class="col-5">
                                                                    <span class="text-danger count-num2 me-1 fs-14">{{__('messages.campaign.goal')}}</span>
                        ...
                        <!-- end time-counter section -->
                            ...
                            @if($campaign->goal)
                                <section class="news-right-section time-count-section bg-light p-30 rounded-10 mb-20 position-relative">
                                    ...
                                    <div class="row">
                                        <div style="display: none" class="col-xl-6 col-md-3 col-sm-6  text-center pt-4">
                                        ...
                                        <div class="button col-xl-6 col-md-3 col-sm-6 align-items-center pt-4">
                                            <a href="{{route('landing.payment', $campaign->slug)}}"
                                               class="btn btn-danger w-100 mt-3{{ ((getSettingValue('stripe_enable')) == 1 || (getSettingValue('paypal_enable')) == 1 ? '' : '' )}}">{{__('messages.front_landing.donate_now')}}</a>
                                        </div>
                                    </div>
                        ...
                        <!-- end time-count-section -->
                            ...
                            <div class="input-group mb-20">
                                ...
                                <div class="input-group-append">
                                    <button class="input-group-text btn-danger p-3 fs-14 copy-link" data-link="{{ $shareUrl }}">Copy</button>
                                </div>
                            </div>
                            <!--end input-section -->
