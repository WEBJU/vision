...
<footer class=" bg-dark pt-100 pb-100">
    <div class="container">
        <div class="row  justify-content-between">
            <div class="col-lg-6 ">
                <div class="footer-left mb-lg-0 mb-4">
                    <div class=" mb-4 pb-lg-2 d-flex align-items-center gap-3">
                        <div class="vision-img">
                            <a href="{{route('landing.home') }}">
                                <img src="{{asset('front_landing/images/cropped-logo.png')}}" alt="Vision Changers"
                                     class="w-100 h-100 object-fit-cover"/>
                                     {{-- <img src="{{getLogoUrl() ? : asset('front_landing/images/funding-logo.png')}}" alt="Vision Changers"
                                     class="w-100 h-100 object-fit-cover"/> --}}
                            </a>
                        </div>
                       <div class="vision-img">
                        <a href="{{route('landing.home') }}">
                            <img src="{{asset('images/ngosource.png')}}" alt="Vision Changers"
                                 class="w-100 h-100 object-fit-cover"/>
                ...
                <div class="footer-right ps-xl-3">
                    ...
                    <div class="email-box position-relative">
                        <form action="{{route('email.subscribe.store')}}" method="post" id="addEmailForm"
                            ...
                            <button type="submit" id="emailBtn" class="button btn-danger position-absolute fs-14 fw-5">
