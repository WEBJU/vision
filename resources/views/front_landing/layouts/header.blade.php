                ...
                <div class="header-logo">
                    <a href="{{ route('landing.home') }}">
                        <img src="{{ asset('front_landing/images/logo.png')}}" alt="Vision Changers Kenya"
                            class="w-100 h-100" />
                        {{-- <img src="{{ getLogoUrl() ? : asset('front_landing/images/logo.png')}}"
                            alt="Vision Changers Kenya" class="w-100 h-100" /> --}}
                    </a>
                </div>
            </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light justify-content-end py-0 navbar-fixed">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                        <ul class="navbar-nav align-items-center py-2 py-lg-0">
                            ...
                            <li class="nav-item">
                                <a href="#"
                                    class="text-dark nav-link fw-5 fs-14 {{ Request::is('programs', 'faqs', 'events', 'teams', 'event-details/*', 'page*') ? 'active' : '' }}">
                                    What we do <span><i class="fas fa-chevron-down"></i></span>
                                </a>
                                <ul class="dropdown-nav ps-0">
                                    <li>
                                        <a href="{{ route('landing.programs') }}"
                                            class="fs-14 fw-5 {{ Request::is('programs') ? 'active' : '' }}">
                                            Programs
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('landing.faqs') }}"
                                            class="fs-14 fw-5 {{ Request::is('faqs') ? 'active' : '' }}">
                                            FAQs
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('landing.event') }}"
                                            class="fs-14 fw-5 {{ Request::is('events', 'event-details/*') ? 'active' : '' }}">
                                        ...
                                        @if($page->is_active)
                                            <li>
                                                <a href="{{ route('landing.page.detail', $page->id) }}"
                                                    class="fs-14 fw-5 {{ Request::is('page*') ? 'active' : '' }}">
                                    ...
                                    <li>
                                        <a href="{{ route('landing.projects') }}"
                                            class="fs-14 fw-5 {{ Request::is('projects') ? 'active' : '' }}">
                                            Projects
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('landing.team') }}"
                                            class="fs-14 fw-5 {{ Request::is('teams') ? 'active' : '' }}">
                            ...
                            <li class="nav-item">
                                <a href="#"
                                    class="text-dark nav-link fw-5  fs-14 {{ Request::is('news', 'reports', 'galleries', 'podcasts') ? 'active' : '' }}">Publications
                                    <span><i class="fas fa-chevron-down"></i></span></a>
                                <ul class="dropdown-nav ps-0">
                                    <li><a href="{{ route('landing.publications', ['category' => 'news']) }}"
                                            class="fs-14 fw-5 {{ Request::is('news') || Request::is('publication/news') ? 'active' : '' }}">News</a>
                                    </li>

                                    <li><a href="{{ route('landing.publications', ['category' => 'podcast']) }}"
                                            class="fs-14 fw-5 {{ Request::is('publication/podcast') ? 'active' : '' }}">Podcast</a>
                                    </li>

                                    <li><a href="{{ route('landing.publications', ['category' => 'reports']) }}"
                                            class="fs-14 fw-5 {{ Request::is('publication/reports') ? 'active' : '' }}">Reports</a>
                                    </li>
                            ...
                            <li class="nav-item">
                                <a class="text-dark nav-link  fw-5 fs-14 {{ Request::is('news', 'news-details*') ? 'active' : '' }}"
                                    href="{{ route('landing.publications') }}">Blogs</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="offcanvas-toggle d-lg-none d-block text-end text-dark">
                    ...
                    <div class="offcanvas offcanvas-end text-start" tabindex="-1" id="offcanvasRight"
                        ...
                        <div class="offcanvas-body p-0">
                            ...
                            <div class="nav-item">
                                <a class="nav-link  fw-5 fs-14 {{ Request::is('publications', 'news-details*') ? 'active' : '' }}"
                                    href="{{ route('landing.publications') }}">{{__('messages.news.news')}}</a>
                            </div>
                            <div class="nav-item">
