                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-7 parallelogram-shape">
                            <div class="text-white inner-text position-relative">
                                ...
                                <h2 class="fs-3 mb-md-0 fw-6">Civic Participation</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row pt-100">
                    <div class="col-xl-8">
                        <div class="cause-image mb-20 rounded-20">
                            ...
                            <img src="{{ asset('front_landing/images/vision-17.jpg') }}" alt="causes-image" class="w-100 h-100 object-fit-cover">
                        </div>
                        <div class="cause-desc mb-40">
                            <h3 class="fw-6 fs-26 text-dark mb-3">Civic Participation</h3>
                            <div class="desc-box d-flex flex-wrap">
                                <div class="d-flex align-items-center me-lg-5 me-4">
                                    ...
                                    <p class="fs-16 fw-5 text-danger mb-0">Civic</p>
                                </div>
                            </div>
                        </div>
                        <div class="cause-tab">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active mb-5" id="pills-home" role="tabpanel"
                                    ...
                                    <p class="fs-16 fw-5 text-dark mb-lg-4 mb-3 text-justify">
                                        We believe that active engagement in civic life is essential for sustainable community development. We empower youth to play pivotal roles in decision-making and accountability processes, championing their rights and responsibilities as citizens. Our civic participation initiatives include planned workshops, dialogue forums, town hall meetings, and community sports festivals, all designed to amplify diverse voices and foster inclusivity. These activities promote participatory decision-making, ensuring that every community member has a platform to be heard. By nurturing a culture of civic engagement, we aim to strengthen community cohesion and create a ripple effect of positive change.
                                    </p>
                                </div>
                            </div>
                        </div>
