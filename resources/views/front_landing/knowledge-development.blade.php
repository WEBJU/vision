    ...
    <div class="cause-details-page">
        ...
        <section class="hero-section">
            <div class="inner-bgimg position-relative"
                 style="background: url('{{ asset('front_landing/images/vision-6.jpg') }}')">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-7 parallelogram-shape">
                            <div class="text-white inner-text position-relative">
                                ...
                                <h2 class="fs-3 mb-md-0 fw-6">Knowledge Development and Learning</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row pt-100">
                    <div class="col-xl-8">
                        <div class="cause-image mb-20 rounded-20">
                            ...
                            <img src="{{ asset('front_landing/images/vision-7.jpg') }}" alt="causes-image" class="w-100 h-100 object-fit-cover">
                        </div>
                        <div class="cause-desc mb-40">
                            <h3 class="fw-6 fs-26 text-dark mb-3">Knowledge Development and Learning</h3>
                            <div class="desc-box d-flex flex-wrap">
                                <div class="d-flex align-items-center me-lg-5 me-4">
                                    ...
                                    <p class="fs-16 fw-5 text-danger mb-0">Education</p>
                                </div>
                            </div>
                        </div>
                        <div class="cause-tab">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active mb-5" id="pills-home" role="tabpanel"
                                    ...
                                    <p class="fs-16 fw-5 text-dark mb-lg-4 mb-3 text-justify">
                                        Through targeted programs, we aim to enhance the skills and knowledge of individuals, equipping them with the tools they need to thrive in various aspects of life. Our initiatives prioritize the development of both technical expertise and soft skills—critical thinking, communication, and teamwork—ensuring that our participants are well-rounded and prepared for the challenges ahead. Furthermore, our mentorship programs connect youth with experienced professionals, offering invaluable guidance and real-world insights. By investing in learning and knowledge development, we lay the foundation for a generation that can lead with confidence and competence.
                                    </p>
                                </div>
                            </div>
                        </div>
