                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 col-md-7 mt-3 mt-md-4">
                                            ...
                                            <img src="{{asset('front_landing/images/events-hero-img.png')}}" alt="Vision Changers"
                        ...
                        <div class="card h-100 bg-white">
                            <div class="card-body d-flex align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <p class="card-text text-dark">Contribute to initiatives that empower communities and drive sustainable change.</p>
                        ...
                        <div class="card h-100">
                            <div class="card-body d-flex bg-dark align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <p class="card-text text-white">Join us in changing lives of the youth for better leaders of tomorrow.</p>
                                    <a href="/register" class="custom-button">Join Now</a>
                                </div>
                                <div class="rounded p-3">
                                    <img src="{{asset('front_landing/images/about-us2.png')}}"
