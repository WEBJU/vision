<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            {{ Form::label('campaign_id', __('messages.campaign.campaign') . ':', ['class' => 'form-label required']) }}
            {{ Form::select('campaign_id', $campaigns, null, ['class' => 'form-select', 'required', 'placeholder' => __('Select Program'), 'id' => 'campaignId', 'data-control' => 'select2']) }}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-5">
