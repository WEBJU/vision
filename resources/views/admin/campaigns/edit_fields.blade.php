                    ...
                    <div class="row">
                                ...
                                <div class="d-block">
                                    <div class="image-picker">
                                        <div class="image previewImage" id="exampleInputImage"
                                            style="background-image: url('{{ isset($campaign) ? $campaign->image : asset('front_landing/images/cause-details.png') }}')">
                                        </div>
                        ...
                        <div class="col-12 d-flex align-items-center mb-3">
                            ...
                            <label class="form-check form-switch form-check-custom form-switch-sm ms-3">
                                <input type="checkbox" name="gift_status" class="form-check-input gift-enable" value="1"
                                    {{ $campaign->gift_status == 1 ? 'checked' : ''}} id="giftStatus">
                    ...
                    <div class="col-sm-6">
                        ...
                        <select id="currencyType" data-show-content="true" class="form-select form-select-solid"
                            ...
                            @foreach($currencies as $key => $currency)
                                <option value="{{$key}}" {{$campaign->currency == $key ? 'selected' : ''}}>
                                    {{ $currency['symbol'] }}
                                    &nbsp;&nbsp;&nbsp; {{$currency['name']}}
                                </option>
                            @endforeach
                    ...
                    <div class="col-lg-3 mb-5" style="display: none">
                        ...
                        <label class="form-check form-switch form-check-custom form-check-solid form-switch-sm">
                            <input type="checkbox" name="is_emergency" class="form-check-input editIsEmergency"
                                value="1" {{ (isset($campaign) && $campaign->is_emergency == 1) ? 'checked' : '' }}>
                        </label>
                    </div>
