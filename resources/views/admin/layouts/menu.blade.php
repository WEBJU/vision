...
<li class="nav-item {{ Request::is('admin/projects*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('projects.index') }}">
        <span class="aside-menu-icon pe-3"><i class="fa fa-donate fs-3"></i></span>
        <span class="aside-menu-title">{{ __('messages.project.projects') }}</span>
    </a>
</li> 
@can('manage_events')
