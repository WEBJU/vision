<div>
    @if($newsies->count() > 0)
            ...
            <div class="col-12 news-card mb-20">
                <div class="card">
                    <div class="position-relative">
                        ...
                        <span class="badge small-btn">{{ isset($news->category_name) ? $news->category_name : '' }}</span>
                    </div>
                    <div class="card-body pt-0">
                        <h4 class="card-title text-dark fw-6 fs-20 pb-1">
                            <a class="text-dark" href="{{ route('landing.news-details', $news->slug) }}">
                        ...
                        <div class="d-flex flex-wrap justify-content-between align-items-center">
                            <div class="d-flex">
                                ...
                                <span class="fs-14 fw-5 text-dark my-auto">
                                    @foreach($news->users as $user)
                            ...
                            <div class="d-flex ml-auto">
                                <div class="mx-2 my-2 ps-1">
                                    ...
                                    <span class="fs-14 fw-5 text-primary">{{ $news->news_comments_count }} {{ __('messages.news_comments.comments') }}</span>
                                </div>
                                <div class="my-2">
        ...
        @endforeach
    @else
        <h3>{{ __('No news publication for this category.') }}</h3>
    @endif
