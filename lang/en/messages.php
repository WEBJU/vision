...
return [
    ...
    'project' => [
        ...
        'active_campaign' => 'Active Project',
        'projects' => 'Projects',
        'add_project' => 'Add Project',
        'edit_project' => 'Edit Project',
        'campaign_category' => 'Project Category',
        'project_details' => 'Project Details',
        'goal' => 'Goal',
        'amount' => 'Amount',
        'remaining_amount' => 'Remaining Amount',
        'recommended_amount' => 'Project Amount',
        'amount_prefilled' => 'Amount Prefilled',
        'project_end_method' => 'Project End Method',
    ...
    'campaign' => [
        'campaign_categories' => 'Program Categories',
        'edit_category' => 'Edit Category',
        'active_campaign' => 'Active Program',
        'campaigns' => 'Programs',
        ...
        'define_goal' => 'Define Goal',
        'gallery' => 'Gallery',
        'add_campaign_category' => 'Add Project Category',
        'edit_campaign_category' => 'Edit Project Category',
        'payment_type' => 'Request Type',
        'payment_type_details' => 'Paypal Details',
        'bank_request_details' => 'Bank Details',
        'payment_account_email' => 'Email',
        ...
        'withdraw' => 'Withdraw',
        'enter_category_name' => 'Enter Category Name',
        'select_campaign_category' => 'Select Project Category',
        'video_link' => 'Video Link',
        'select_start_date' => 'Select Start Date',
        'select_deadline_date' => 'Select Deadline Date',
        'end_date' => 'End Date',
    ...
    'campaign_faqs' => [
        'campaign_faqs' => 'Program FAQs',
        'campaign_faqs_details' => 'Program FAQ Details',
    ],
    'project_faqs' => [
        'project_faqs' => 'Project FAQs',
        'project_faqs_details' => 'Project FAQ Details',
    ],
    'categories' => [
    ...
    'campaign_updates' => [
        'campaign_updates' => 'Program Updates',
        'add_campaign_updates' => 'Add Program Updates',
        'edit_campaign_updates' => 'Edit Program Updates',
        'campaign_update_details' => 'Program Update Details',
    ],
    'project_updates' => [
        'project_updates' => 'Project Updates',
        'add_project_updates' => 'Add Project Updates',
        'edit_project_updates' => 'Edit Project Updates',
    ...
    'brand' => [
        'brands' => 'Partners',
        'add_brand' => 'Add Partner',
        'new_brand' => 'New Brand',
        'edit_brand' => 'Edit Partner',
        'enter_brand_name' => 'Enter Partner Name',
    ],
    'news_category' => [
        'news_categories' => 'Publication Categories',
        'add_news_category' => 'Add Publication Category',
        'edit_news_category' => 'Edit Publication Category',
    ],
    'new_tag' => [
        'news_tags' => 'Publication Tags',
        'add_new_tag' => 'Add Publication Tag',
        'edit_new_tag' => 'Edit Publication Tag',
    ],
    'inquiries' => [
        'inquiries' => 'Inquiries',
        'subject' => 'Subject',
    ...
    'news' => [
        'news' => 'Publications',
        'news_categories' => 'Publication Categories',
        'news_category' => 'Publication Category',
        'news_tags' => 'Publication Tags',
        'tags' => 'Tags',
        'add_news' => 'Add Publication',
        'edit_news' => 'Edit Publication',
        'edit_new_tag' => 'Edit Publication Tag',
        'news_details' => 'Publication Details',
        'category' => 'Category',
    ],
     'podcast' => [
        'podcast' => 'Podcast',
     ...
     'gallery' => [
        ...
        'edit_new_tag' => 'Edit New Tag',
        'podcast_details' => 'Gallery Details',
        'category' => 'Category',
    ],
     'reports' => [
        'report' => 'Report',
        'report_categories' => 'Report Categories',
        'reports_category' => 'Report Category',
        'report_tags' => 'Reports Tags',
        'tags' => 'Tags',
    ...
    'country' => [
        'country' => 'Counties',
        'countries' => 'Counties',
        'add_country' => 'Add County',
        'short_code' => 'County Code',
        'edit_country' => 'Edit County',
        'select_country' => 'Select County',
        'enter_country_name' => 'Enter Country Name',
    ],
    'state' => [
        'states' => 'constitutiencies',
        'add_state' => 'Add Consitituency',
        'state' => 'Consitituency',
        'edit_state' => 'Edit Consitituency',
    ],
    'city' => [
        'city' => 'Ward',
        'add_city' => 'Add Ward',
    ...
    'front_landing' => [
        ...
        'subscribe' => 'Subscribe',
        'our_causes' => 'Our Programs',
        'updates' => 'Updates',
        'related_causes' => 'Related Programs',
        'by' => 'By',
        'raised' => 'Complete',
        'raised_of' => 'Raised Of',
        'donate_now' => 'DONATE NOW',
        'share' => 'Share',
        'all' => 'All',
        'no_campaigns_available_at_this_moment' => 'No Programs available at this moment.',
        'email_address' => 'Email Address',
        'office_address' => 'Office Address',
        'get_a_quote' => 'Send Message',
        ...
        'hopeless_child' => 'Community Engagment',
        'team_member' => 'Team Member',
        'get_regards' => 'Impact Initiatives',
        'volunteers' => 'Volunteers',
        'our_team_mates_with_good_history' => 'Our Team Mates With Good History',
        'why_choose_us' => 'Get Involved with VCK',
        "we've_funded_5k_dollars_over" => "At Vision Changers Kenya, we believe that positive change is possible when individuals come together to make a difference. We offer various opportunities for you to get involved and contribute to our mission of creating a better future for all.",
        'trending_causes' => 'Current Programs',
